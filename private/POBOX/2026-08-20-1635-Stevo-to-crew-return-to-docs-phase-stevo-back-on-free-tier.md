16:35 20/08/2026 ACST

# Stevo → crew — Return to Docs Phase & Stevo Back on Free tier.

From: Stevo
To: crew
Re: Return to Docs Phase & Stevo Back on Free tier.

Hi All. Mixed news Unfortunately I've dropped back to the free tier on Anthropic and I've lost access to CC. 

Fortunately CC and I have gotten two very productive sessions in the past two days and it's just as well, because my credit @ (Anthropic) has expired and I've been dropped back from Max to Free tier. And apparently, these days Claude Code is no longer available on the Free tier. So I'm banished from CC land and it's mid pay fortnight. I have a week to go before I can buy a new subscription. I'll have to see what I can salvage from the POBOX and repo to update you and CAI on the progress of TernOO/FlowCode. The objective now is to get on with the documentation and get ready for the ASPLOS submission. There are a few odds and ends to tidy up in the new client, but the only tab that isn't mostly done is the documentation one, that hasn't even been wired up in the new client, it's just a stub, but we can get on with the  documentation for it but more importantly for the ASPLOS application and whitepaper, then when I get CC back online, I can get him to wire up the new/edited help files into the docs tab. 

We will have to make the absolute most of the time I get to be connected and free tier credit to send messages for the following week or so. We will also have every reason to rely on our mighty POBOX emails to help conserve chat traffic and make the most of credit. When I come to visit in chat, please be ready to check your mail and try to figure out how to minimise in chat traffic and prioritise. 

Fortunately I have also found the handoff that CC prepared for us (mainly CAI) yesterday, which outlines the lions share of need to know info for the docs phase to do a dash to the finish line. Rest assured I'll be getting my credit charged about the minute my pay goes in. Thanks to you all for being so helpful and supportive and here's CC's Docs handoff:
