...
STROKES = {
    ...
    '(': [[(3, 6), (2, 4), (2, 2), (3, 0)]],
    ')': [[(1, 6), (2, 4), (2, 2), (1, 0)]],
    # ── technical / math band (house-default; O4 charter raw-material) ──
    '+': [[(0, 3), (4, 3)], [(2, 1), (2, 5)]],
    '−': [[(0, 3), (4, 3)]],                        # minus (wide; hyphen stays narrow)
    '×': [[(0, 5), (4, 1)], [(0, 1), (4, 5)]],
    '÷': [[(2, 5)], [(0, 3), (4, 3)], [(2, 1)]],
    '=': [[(0, 2), (4, 2)], [(0, 4), (4, 4)]],
    '≠': [[(0, 2), (4, 2)], [(0, 4), (4, 4)], [(1, 0), (3, 6)]],
    '<': [[(4, 5), (0, 3), (4, 1)]],
    '>': [[(0, 5), (4, 3), (0, 1)]],
    '≤': [[(4, 5), (0, 3), (4, 1)], [(0, 0), (4, 0)]],
    '≥': [[(0, 5), (4, 3), (0, 1)], [(0, 0), (4, 0)]],
    '±': [[(2, 6), (2, 2)], [(0, 4), (4, 4)], [(0, 0), (4, 0)]],
    '/': [[(0, 0), (4, 6)]],
    '\\': [[(0, 6), (4, 0)]],
    '*': [[(2, 6), (2, 2)], [(0, 5), (4, 3)], [(0, 3), (4, 5)]],
    '^': [[(1, 4), (2, 6), (3, 4)]],
    '%': [[(0, 0), (4, 6)], [(1, 5)], [(3, 1)]],
    '·': [[(2, 3)]],
    '_': [[(0, -1), (4, -1)]],
    '|': [[(2, 6), (2, -1)]],
    '#': [[(1, 6), (1, 0)], [(3, 6), (3, 0)], [(0, 2), (4, 2)], [(0, 4), (4, 4)]],
    '[': [[(3, 6), (1, 6), (1, 0), (3, 0)]],
    ']': [[(1, 6), (3, 6), (3, 0), (1, 0)]],
    '{': [[(3, 6), (2, 6), (2, 4), (1, 3), (2, 2), (2, 0), (3, 0)]],
    '}': [[(1, 6), (2, 6), (2, 4), (3, 3), (2, 2), (2, 0), (1, 0)]],
    '→': [[(0, 3), (4, 3)], [(2, 5), (4, 3), (2, 1)]],
    'π': [[(0, 4), (4, 4)], [(1, 4), (1, 0)], [(3, 4), (3, 0)]],
    '√': [[(0, 2), (1, 0), (2, 6), (4, 6)]],
    'Δ': [[(0, 0), (2, 6), (4, 0), (0, 0)]],
    '°': [[(1, 6), (2, 6), (2, 5), (1, 5), (1, 6)]],
    '∑': [[(4, 6), (0, 6), (2, 3), (0, 0), (4, 0)]],
    '∫': [[(3, 6), (2, 6), (2, -1), (1, -1)]],       # best-effort — wants the eye
    '∞': [[(2, 3), (1, 4), (0, 3), (1, 2), (2, 3), (3, 4), (4, 3), (3, 2),
          (2, 3)]],
    'space': [],
}
